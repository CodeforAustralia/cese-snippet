...
class ProgramForm extends React.Component {
  ...
  render() {
    ...
    const getStaffOptions = () =>
      staticData.staff.map(staff => ({ value: staff.id, label: staff.email }));
    ...
    return (
      <Form noValidate={true} onSubmit={handleSubmit}>
        ...
        <FormGroup>
          ...
          />
          {!!errors.category &&
            touched.category && <FormFeedback>{errors.category}</FormFeedback>}
        </FormGroup>
        <FormGroup>
        ...
        {}
        <p onClick={() => this.toggleShowDetail()}>
                ...
                {yearLevelsOptions.map((o, idx) => {
                  const isChecked =
                    typeof values.yearLevels !== 'undefined'
                      ? values.yearLevels.includes(o.value)
                      : false;
                  return (
                    <div key={idx} className="form-check form-check-inline">
                      <label className="form-check-label">
        ...
        <FormGroup>
          ...
          />
          <FormText color="muted">
            Who are the staff members involved in organising or facilitating the
            program?
          </FormText>
        </FormGroup>
